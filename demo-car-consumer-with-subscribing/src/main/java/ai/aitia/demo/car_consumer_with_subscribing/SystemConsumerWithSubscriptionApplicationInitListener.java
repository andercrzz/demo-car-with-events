...
@Component
public class SystemConsumerWithSubscriptionApplicationInitListener extends ApplicationInitListener {
	...
	private final Logger logger = LogManager.getLogger(SystemConsumerWithSubscriptionApplicationInitListener.class);
	...
	public SystemConsumerWithSubscriptionTask getConsumerTask() {
		return new SystemConsumerWithSubscriptionTask();
	}
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		final SystemConsumerWithSubscriptionTask consumerTask = applicationContext.getBean(SubscriberConstants.CONSUMER_TASK, SystemConsumerWithSubscriptionTask.class);
		consumerTask.start();
